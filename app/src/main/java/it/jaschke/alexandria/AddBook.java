...
public class AddBook extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final String TAGBARCODE = "BarcodeMain";
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ean.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                bookIntent.putExtra(BookService.INTERNET, internetConnection);
...
//                toast.show();
                    ...
                    intent.putExtra(BarcodeCaptureActivity.AutoFocus, true);//use autofocus all the time
                    intent.putExtra(BarcodeCaptureActivity.UseFlash, false); //donot use flash all the time
